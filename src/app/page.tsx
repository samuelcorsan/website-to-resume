      ...
      <main className="relative flex w-full max-w-xl flex-col items-center justify-center px-8 py-16">
        <div className="w-full space-y-10">
          ...
          <div className="flex justify-center pt-4">
            <a
              href="https://github.com/samuelcorsan/website-to-resume"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 px-4 py-2 rounded-full text-sm text-zinc-500 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 transition-all duration-300 hover:bg-zinc-100 dark:hover:bg-zinc-900"
            >
              <svg
